...
export default function Advertise() {
  ...
  return (
    <>
      <Head>
        <title>广告合作 - 方略 Fanglue</title>
        <meta name="description" content="与方略合作 - 如果你希望与方略合作，或者对古典书籍和文化感兴趣，欢迎随时联系我们" />
      ...
      <div className={styles.container}>
        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.pageTitle}>
            <h1 className={styles.titleLine}>广告合作</h1>
          </div>

          {/* 正文内容 */}
          <div className={styles.contentSection}>
            <div className={styles.contentText}>
              <p>方略致力于将古代经典与现代生活相结合，如果您的品牌、产品或服务与方略的理念相契合，我们非常欢迎与您展开深度合作</p>
              
              <p>我们相信，真正有价值的合作不仅仅是商业层面的互利，更是文化传承与创新理念的共鸣</p>
              
              <p>如有合作意向，请发送邮件至 contact@fanglue.org，我们会在72小时内与您取得联系</p>
            </div>
          </div>
        </main>
